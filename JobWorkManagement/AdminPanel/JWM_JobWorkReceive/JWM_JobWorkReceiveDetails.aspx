        ...
        <div class="block">
            ...
            <div class="card shadow">
                <div class="card-header py-3">
                    <p class="text-primary m-0 text-xl-center font-weight-bold"><i class="fas fa-exclamation-circle sidebar-brand-text mx-1"></i><span>Work Receive Info</span></p>
                </div>
            </div>
            <div class="card shadow">
                <div class="card-body">
                    <div class="form-horizontal table-responsive" role="form">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lblJobWorkReceiveDate_XXXXX" Text="Job Type" runat="server"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="lblJobWorkReceiveDate" runat="server"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
