                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label class="col-md-6">
                                        <i class="sidebar-brand-text mx-1" style="font-size: medium"></i>Job Type ID &nbsp; : &nbsp;
                                        <asp:Label ID="lblJobTypeID" runat="server" Text='<%# string.Concat(" : ",Eval("JobTypeID")) %>'></asp:Label>
                                    </label>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-6">
